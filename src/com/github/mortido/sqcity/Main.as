package com.github.mortido.sqcity
{
    ...
    public class Main extends Sprite
    {
        public function Main()
        {
            ...
            config.imageInfos["@image/field"] = new ImageInfo("https://dl.dropboxusercontent.com/u/15020766/sq/field.jpg", 539, 74);
            config.imageInfos["@image/building/factory"] = new ImageInfo("https://dl.dropboxusercontent.com/u/15020766/sq/factory.png", 109, 52);
            config.imageInfos["@image/building/house"] = new ImageInfo("https://dl.dropboxusercontent.com/u/15020766/sq/house.png", 60, 38);
            config.imageInfos["@image/building/wind_power"] = new ImageInfo("https://dl.dropboxusercontent.com/u/15020766/sq/wind_power.png", 52, 76);
            config.imageInfos["@image/contract/factory1"] = new ImageInfo("https://dl.dropboxusercontent.com/u/15020766/sq/contract_1.png", 0, 0);
            config.imageInfos["@image/contract/factory2"] = new ImageInfo("https://dl.dropboxusercontent.com/u/15020766/sq/contract_2.png", 0, 0);
